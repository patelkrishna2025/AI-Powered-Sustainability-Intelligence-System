# 🌍 AI-Powered Sustainability Intelligence System — v3

## 📁 Project Structure

```
Project/
├── app.py                          ← Streamlit dashboard (8 tabs — UPDATED v3)
├── README.md                       ← This file
│
...
│
├── weather/                        ← ✨ NEW — Weather Prediction module
...
| 8 | 🌦️ Weather Prediction | **NEW** — AI weather forecasting & climate analysis |
...
| 9 | Chatbot Demo |
| 10 | **Weather Prediction Module** ← NEW |
